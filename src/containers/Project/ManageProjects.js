...
class ManageProjects extends React.Component {
	render() {
		...
		const editProjectDescription = (e) => {
		...
		return (
			<li className='list-group-item clearfix add-space'>
				...
				{this.props.isRoleManager &&
					<p>
						<button type="button" className="btn btn-danger add-space" onClick={removeProject}>Delete</button> {' '}
							...
							<div className="col-xs-12">
								<div className="input-group input-group-sm">
									...
									<div className="input-group-btn">
										<button type="button" className="btn btn-info btn-width add-space" data-toggle="collapse" href={href} aria-expanded="false" aria-controls="collapseExample" onClick={editProjectDescription}>Edit Description</button>
									</div>
								</div>
								<div className="input-group input-group-sm">
									...
									<div className="input-group-btn">
										<button type="button" className="btn btn-info btn-width add-space" data-toggle="collapse" href={href} aria-expanded="false" aria-controls="collapseExample" onClick={editBeginningDate}>Beginning Date</button>
									</div>
								</div>
								<div className="input-group input-group-sm">
									<input type="date" className="form-control add-space" required ref={(input) => this.editedDueDate = input} placeholder="Due Date" />
									<div className="input-group-btn">
										<button type="button" className="btn btn-info btn-width add-space" data-toggle="collapse" href={href} aria-expanded="false" aria-controls="collapseExample" onClick={editDueDate}>Due Date</button>
									</div>
								</div>
							</div>
						</div>
