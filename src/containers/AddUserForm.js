            ...
            <div className="input-group input-group-lg add-space">
              ...
              <div className="form-group">Role: {' '}
								<label className="radio-inline form-control">
									<input type="radio" name="optradio" value="manager" ref={node => {role = node}} checked/>Manager
								</label>
								<label class="radio-inline form-control">
									<input type="radio" name="optradio" value="employee" ref={node => {role = node}}/>Employee
								</label>
              </div>
